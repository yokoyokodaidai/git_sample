      ...
      var L = (A.tablesorter = {
          ...
          if (
            ...
            (t.hasInitialized = !1),
              ...
              (r.supportsDataObject =
                (((e = A.fn.jquery.split("."))[0] = parseInt(e[0], 10)),
            ...
            t
              ...
              .bind(o, function (e, t) {
                ...
                if (
                  !(
                    (1 !== (e.which || e.button) &&
                      !n.match(" " + i.pointerClick + " | sort | keyup ")) ||
                  ...
                  i.delayInit && L.isEmptyObject(i.cache) && L.buildCache(i),
                    ...
                    (o = i.$headerIndexed[i.last.clickedIndex][0]) &&
                      !o.sortDisabled &&
                      L.initSort(i, o, e);
                }
              }),
                  ...
                  if (!L.getClosest(i, "tr").hasClass(d.cssIgnoreRow))
                    return (
                      ...
                      "" === d.headerTemplate ||
                        ...
                        ((a = d.headerTemplate
                          ...
                          .replace(
                            ...
                            i.find("." + L.css.icon).length ? "" : l
                          )),
                        d.onRenderTemplate &&
                          (o = d.onRenderTemplate.apply(i, [t, a])) &&
                          "string" == typeof o &&
                          (a = o),
                        i.html(
                          '<div class="' + L.css.headerIn + '">' + a + "</div>"
                        )),
                      d.onRenderHeader &&
                        d.onRenderHeader.apply(i, [t, d, d.$table]),
                      (s = parseInt(i.attr("data-column"), 10)),
                      (e.column = s),
                      (n = L.getOrder(
                        L.getData(i, r, "sortInitialOrder") ||
                          d.sortInitialOrder
                      )),
                      (d.sortVars[s] = {
                        count: -1,
                      ...
                      void 0 !== (n = L.getData(i, r, "lockedOrder") || !1) &&
                        !1 !== n &&
                        ((d.sortVars[s].lockedOrder = !0),
                        (d.sortVars[s].order = L.getOrder(n)
                          ? [1, 1]
                          : [0, 0])),
                      (d.headerList[t] = e),
                ...
                if (c.hasClass(e.cssChildRow) && 0 !== n)
                  for (
                    ...
                    (u = p[i]) &&
                      ...
                      0 < (w = p[i].colSpan - 1) && ((x += w), (C += w))),
                      x++;
                else {
                  for (
                    m.$row = c, m.order = n, x = 0, C = e.columns, i = 0;
                    i < C;
                    ++i
                  ) {
                    if (
              ...
              if (
                (g = (g = a.$headers.filter(function (e) {
                  for (
                    var t = !0,
                      r = a.$headers.eq(e),
                      o = parseInt(r.attr("data-column"), 10),
                      s = o + L.getClosest(r, "th, td")[0].colSpan;
                    o < s;
                    o++
                  )
        ...
        updateCell: function (e, t, r, o) {
          if (A(t).closest("tr").hasClass(e.cssChildRow))
            ...
            if (L.isEmptyObject(e.cache))
              return L.updateHeader(e), void L.commonUpdate(e, r, o);
            ...
            if (((t = g[0]), c.length && 0 <= p)) {
              ...
              (s = L.getElementText(e, t, i)),
                ...
                (d[i] = s),
                "numeric" === (e.parsers[i].type || "").toLowerCase() &&
                  (u.colMax[i] = Math.max(Math.abs(s) || 0, u.colMax[i] || 0)),
        ...
        addRows: function (e, t, r, o) {
          ...
          if (b) (t = A(t)), e.$tbodies.append(t);
            ...
            !(t && t instanceof A && L.getClosest(t, "table")[0] === e.table)
          )
            return (
              L.debug(e, "core") &&
                console.error(
            ...
            for (
              ...
              for (
                p = 0,
                  ...
                  f = [],
                  u = { child: [], raw: [], $row: t.eq(i), order: g },
                  l = 0;
                l < c;
                l++
              )
                (h = t[i].cells[l]),
                  ...
                  (f[p] = a),
                  "numeric" === (e.parsers[p].type || "").toLowerCase() &&
        ...
        initSort: function (t, e, r) {
          ...
          if (
            ...
            for (a = 0; a < p; a++)
              (l = t.$headers.eq(a)),
                f !== (d = parseInt(l.attr("data-column"), 10)) &&
          ...
          if (c) {
            ...
            for (t.sortVars[f].sortedBy = h, s = 0; s < t.sortList.length; s++)
              (d = t.sortList[s])[0] === f &&
                ...
                2 === d[1] &&
                  (t.sortList.splice(s, 1), (t.sortVars[f].count = -1)));
          else if (
            ((n = m[t.sortVars[f].count]),
            (t.sortVars[f].sortedBy = h),
            n < 2 && ((t.sortList[t.sortList.length] = [f, n]), 1 < u.colSpan))
          )
            for (s = 1; s < u.colSpan; s++)
              (t.sortList[t.sortList.length] = [f + s, n]),
                (t.sortVars[f + s].count = A.inArray(n, m)),
        ...
        multisort: function (l) {
          ...
          if (!l.serverSideSorting && !L.isEmptyObject(l.cache)) {
            if ((L.debug(l, "core") && (t = new Date()), "object" == typeof f))
              for (c = l.columns; c--; )
                "function" == typeof (r = L.getColumnData(g, f, c)) &&
                  (p[c] = r);
            for (e = 0; e < o; e++)
              (c = l.cache[e].colMax),
                l.cache[e].normalized.sort(function (e, t) {
                  ...
                  for (r = 0; r < m; r++) {
                    ...
                    if (
                      (n =
                        (o = /n/i.test(L.getSortType(l.parsers, s))) &&
                        l.strings[s]
                          ? ((o =
                              "boolean" == typeof L.string[l.strings[s]]
                                ? (u ? 1 : -1) *
                                  (L.string[l.strings[s]] ? -1 : 1)
                                : (l.strings[s] && L.string[l.strings[s]]) ||
                                  0),
                            l.numberSorter
                              ? l.numberSorter(e[s], t[s], u, c[s], g)
                              : L["sortNumeric" + (u ? "Asc" : "Desc")](
                                  e[s],
                                  t[s],
                                  o,
                                  c[s],
            ...
            L.debug(l, "core") &&
              console.log("Applying sort " + h.toString() + L.benchmark(t));
          }
        },
        ...
        sortNatural: function (e, t) {
          ...
          for (
            ...
            if (
              ((s = isNaN(r[n]) ? r[n] || 0 : parseFloat(r[n]) || 0),
              (a = isNaN(o[n]) ? o[n] || 0 : parseFloat(o[n]) || 0),
              isNaN(s) !== isNaN(a))
            )
              return isNaN(s) ? 1 : -1;
            if ((typeof s != typeof a && ((s += ""), (a += "")), s < a))
              return -1;
            if (a < s) return 1;
          }
          return 0;
        ...
        hasWidget: function (e, t) {
          return (
            ((e = A(e)).length && e[0].config && e[0].config.widgetInit[t]) ||
            !1
          );
        },
        ...
        addWidgetFromClass: function (e) {
          var t,
            ...
            s =
              "^" +
              o.widgetClass.replace(L.regex.templateName, "(\\S+)+") +
              "$",
            a = new RegExp(s, "g"),
          ...
          if (n.length)
            for (t = n.length, r = 0; r < t; r++)
              n[r].match(a) &&
                (o.widgets[o.widgets.length] = n[r].replace(a, "$1"));
        },
            ...
            if (
              ...
              for (
                c.sort(function (e, t) {
                  ...
                  l &&
                    console[console.group ? "group" : "log"](
                      "Start " + (t ? "initializing" : "applying") + " widgets"
                    ),
                  o = 0;
                o < s;
                o++
          ...
          for (n = t.length, o = 0; o < n; o++)
            (s = L.getWidgetById(t[o])),
              ...
              s &&
                ...
                (L.debug(i, "core") &&
                  console.log(
                    (r ? "Refreshing" : "Removing") + ' "' + t[o] + '" widget'
                  ),
        ...
        refreshWidgets: function (e, t, r) {
          ...
          L.removeWidget(e, l.join(","), !0),
            !0 !== r
              ? (L.applyWidget(e, t || !1, o), t && L.applyWidget(e, !1, o))
              : o(e);
        },
          ...
          return "string" != typeof e || "" === e
            ...
            : ((e = (
              ...
              L.regex.digitNegativeTest.test(e) &&
                (e = e.replace(L.regex.digitNegativeReplace, "-$1")),
              (r = parseFloat(e)),
              isNaN(r) ? A.trim(e) : r);
          var r;
        },
          ...
          if (
            ...
            for (
              i = A('<colgroup class="' + L.css.colgroup + '">'),
                t = n.$table.width(),
                s = (o = n.$tbodies.find("tr:first").children(":visible"))
                  .length,
                a = 0;
              a < s;
              a++
          ...
          if ((e = A(e)[0]).hasInitialized) {
            ...
            var o,
              ...
              i = n
                ...
                .removeClass(L.css.headerRow + " " + a.cssHeaderRow),
            ...
            !1 === t &&
              ...
              L.restoreHeaders(e),
              s.toggleClass(
                L.css.table + " " + a.tableClass + " tablesorter-" + a.theme,
                !1 === t
              ),
      ...
      (A.fn.tablesorter = function (t) {
        ...
        L.addParser({
          ...
          format: function (e, t) {
            ...
            return (
              e &&
                ((e = A.trim(r.ignoreCase ? e.toLocaleLowerCase() : e)),
            ...
            if (e) {
              var s = t.config,
                ...
                n =
                  ...
                  s.dateFormat;
              return (
                a.length && a.data("dateFormat", n), L.convertFormat(e, n) || e
              );
            }
            return e;
          },
        ...
        L.addParser({
          ...
          format: function (e) {
            var t = (e || "").match(L.regex.timeMatch),
              ...
              s = o
                ? new Date(
                    "2000/01/01 " + o.replace(L.regex.dateReplace, "$1 $2")
                  )
                : o;
        ...
        L.addWidget({
          ...
          format: function (e, t, r) {
            ...
            for (i = 0; i < g.length; i++)
              for (
                a = 0,
                  l = (o = g.eq(i).children("tr:visible").not(t.selectorRemove))
                    .length,
                  d = 0;
                d < l;
                d++
