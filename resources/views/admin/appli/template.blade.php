        ...
        <div id="front-wrap">
            ...
            <article class="pl-article-wrap">
                ...
                <div id="appli-make-wrap" class="pl-article-inner">
                    <form class="ui form">
                        <h3 class="ui header">STEP.1 サンプルを選択</h3>
                        <div class="">
                            <p>
                                サンプルを選んでマスタをダウンロードしてください。ダウンロードしたマスタファイルをアップロードできます。
                            </p>
                            <div class="ui four cards appli-list">
                                <div class="ui card">
                                    <div class="sample-image image">
                                        <img
                                            src="{{
                                                asset(
                                    ...
                                    <div class="extra content">
                                        <a
                                            href="{{
                                                asset(
                                                    'images/wireframe/sample.xlsx'
                                                )
                                            }}"
                                            target="_blank"
                                            class="primary ui button basic icon"
                                            ><i
                                                class="ui cloud download icon"
                                            ></i
                                            >マスタダウンロード</a
                                        >
                                    </div>
                        ...
                        <h3 class="ui header">STEP.2 名前設定</h3>
                        <div class="step-cts">
                        ...
                        <h3 class="ui header">STEP.3　マスタアップロード</h3>
                        <div class="step-cts">
                            <div class="input-area-harf">
        ...
        <script>
            $(function () {
                ...
                $(".sample-image").click(function () {
                    ...
                    $("body").append(
                        '<div class="ui basic modal" id="sample-modal"><div class="content"><img src="' +
                            image +
                            '" width="100%" /></div></div>'
                    );
                    $("#sample-modal").remove().modal("show");
                });
            });
        </script>
    </body>
