<div class="ui fullscreen scrolling basic modal modal-record" id="modal-record-edit">
    <i class="close icon"></i>
    <div class="header">
        Select a Photo
    </div>
    <div id="scroll-wrap" class="content">
        <div id="record-wrap">
...
<script>
    $(function() {
        $(".btn-recorde-edit").on("click", function() {
            $("#modal-record-edit").modal("show");
        });
    });
</script>
